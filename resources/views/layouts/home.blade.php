...
@section('content')
    ...
    <style>
        ...
        .pin-wrapper:hover .pin-menu-btn,
        .pin-menu-btn.active {
            opacity: 1;
        }
        ...
        .modal-image-wrapper {
            ...
            height: 100%;
            background: #f8f9fa;
            /* GANTI: Dari hitam (#000) ke abu-abu terang */
            display: flex;
            justify-content: center;
            align-items: center;
            min-height: 400px;
            padding: 24px;
            /* Tambah padding biar foto gak mepet pinggir */
        }
                        ...
                        <div class="col-lg-8 bg-light d-flex align-items-center justify-content-center position-relative">
                            <div class="modal-image-wrapper">
                                ...
                                <button type="button" class="pin-menu-btn pin-menu-btn-modal"
                                    onclick="toggleMenu(event, 'pin-menu-modal-global')">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a id="modalUsername" href="#"
                                                class="fw-bold text-dark text-decoration-none d-block lh-1"></a>
