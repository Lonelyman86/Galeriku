...
@section('content')
    <form class="create-pin" action="{{ route('upload.photo') }}" method="POST" enctype="multipart/form-data">
        ...
        {{-- HIDDEN INPUT UNTUK GAMBAR YANG SUDAH DIRESIZE --}}
        <input type="hidden" name="processed_image" id="processed_image">
    ...
    <script>
        ...
        function handleFile(file) {
            ...
            if (file.type.startsWith('image/')) {
                ...
                const img = new Image();
                img.onload = function() {
                    const maxWidth = 800; // Max width to prevent payload errors
                    let width = img.width;
                    ...
                    document.getElementById('processed_image').value = dataUrl;
                };
                img.src = url;
                ...
                document.getElementById('processed_image').value = '';
            }
        }
    </script>
@endsection
